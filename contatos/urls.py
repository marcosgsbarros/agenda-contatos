...
urlpatterns = [
    ...
    path('cadastrar-contato/',CadastroContatoView.as_view(template_name='contatos/form_contatos.html'),name='cadcontato'),
    path('editar-contato/<int:pk>/',ContatoUpdateView.as_view(template_name='contatos/form_contatos.html'),name='editar'),
    path('deletar-contato/<int:pk>/',ContatoDeleteView.as_view(template_name='contatos/deletar_contato.html'),name='deletar'),
    path('cadastrar-categoria/',CadastroCategoriaView.as_view(template_name='contatos/form_categoria.html'),name='cadcategoria'),
    path('listar-categorias/',CategoriasListView.as_view(template_name='contatos/categorias.html'),name='categorias'),
    path('editar-categoria/<int:pk>/',CategoriaUpdateView.as_view(template_name='contatos/form_categoria.html'),name='editcategoria'),
